interface BadgeCoursesProps {
    variant?: "yellow" | "green" | "emerald" | "red" | "blue" | "gray" | "purple";
    children: React.ReactNode;
    className?: string;
}

export default function BadgeCourse({ variant = "gray", children, className = "" }: BadgeCoursesProps) {
    ...
    return (
        <div
            className={`py-2 px-5 rounded text-[12px] font-semibold flex items-center justify-center ${variantStyles[variant]} ${className}`}
        >
            {children}
        </div>
    );
