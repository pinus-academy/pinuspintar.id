...
interface DetailCoursesLayoutProps {
    course: CourseCardProps;
}

// -------------------- MENU REGISTER EVENT --------------------
const MenuRegisEvent = ({ course }: { course: CourseCardProps }) => {
    const { price, discountPrice, startDate, time, mentor } = course;
...
// -------------------- EVENT PAGE MAIN --------------------
const EventPage2 = ({ course }: DetailCoursesLayoutProps) => {
    const { title, description, benefits, education, image, type } = course;
