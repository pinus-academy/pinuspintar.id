  ...
  export default function CourseCard({
    ...
    const shortDescription = truncateText(description, 100);
      const detaillUrl =  `/events/courses/${id}`;



    return (
      <div className="w-full h-full">
        <Link href={detaillUrl} className="bg-white rounded-lg overflow-hidden shadow-md flex flex-col justify-between h-full transition-transform min-h-[580px] w-[305px] group">
